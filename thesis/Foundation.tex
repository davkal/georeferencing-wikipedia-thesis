...
\todo{english wikipedia is focus for this thesis}
...
Categories can not only consist of pages but also of sub-categories, e.g. ``Arab Spring by country'' has the sub-category ``2011 Libyan civil war''\footurl{http://en.wikipedia.org/wiki/Category:2011_Libyan_civil_war}{2012}{01}{23} which in turn has 5 sub-categories and 55 pages.
