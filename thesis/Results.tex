...
Among those, 85\% came from a different country, \imgref{group-h4}.
...
For \hyp{6}, even fewer articles qualified (18).
...
Over time, the divisions anonymous vs registered and local vs distant do not seem to matter much as the correlation coefficient is 0 for both cases, \imgref{group-h78}.
...
The mean \term{e.surv index} is 95; the mean \term{t.surv index} is 98.
