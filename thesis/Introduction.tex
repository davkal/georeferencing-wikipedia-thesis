...
This is reflected by the Wikipedia articles covering the Arab Spring: there is an overarching parent article\footurl{http://en.wikipedia.org/wiki/2010-2011_Middle_East_and_North_Africa_protests}{2011}{10}{31} as well as single articles covering the revolution in each of the affected countries, e.g. Egypt\footurl{http://en.wikipedia.org/wiki/Egyptian_Revolution_of_2011}{2011}{10}{31} and Libya\footurl{http://en.wikipedia.org/wiki/2011_Libyan_uprising}{2011}{10}{31}.
...
Despite Wikipedia's core policy to oblige everyone to write from a \emph{neutral point of view}\footurl{http://en.wikipedia.org/wiki/Wikipedia:Neutral_point_of_view}{2011}{12}{08} (\abbr{NPOV}), people regularly express opinions. 
...
\todo{Include complete summary and key findings?}
