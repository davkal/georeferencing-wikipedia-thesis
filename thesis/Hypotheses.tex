...
The unbounded time interval after the beginning will be referred to as \term{later}, e.g. all \term{later} revisions denote the set of all article revisions created by contributors after the interval \term{beginning}.
...
\hypothesis{H1}{Articles are created instantly after the start of the event.}
...
\hypothesis{H7}{Articles of political events that have ended tend to shrink in size.}
