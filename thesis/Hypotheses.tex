...
\graffito{rewrite, i want to say, a lot of people use it, so its a natural choice to publish something and do so quickly, i.e. short delay.}
...
\todo{further development needed to identify official languages of countries}
