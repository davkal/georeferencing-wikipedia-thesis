...
Google's implementation of the motion chart is interactive and invites the user to explore the data by allowing to freely choose which metric should be represented by which axis.
