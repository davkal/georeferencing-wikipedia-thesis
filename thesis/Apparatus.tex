...
A timeline chart is used to display the evolution of the several metrics over time: the signature distance, the distance of single revision, and the number of page views for that day, \imgref{activity}.
...
\todo{make this text ratio dependent}
If overall the signature distance rises over time, the correlation coefficient will be positive.
\todo{correlation enough?}
