...
For an automated analysis, simply browsing Wikipedia's website is not really feasible. \todo{why?}
...
\todo{used to get static data useful throughout the analysis process, screen scraping, static data}

\begin{description}
\item[bots] \todo{list of bots}
\item[countries] \todo{country names}
\end{description}
