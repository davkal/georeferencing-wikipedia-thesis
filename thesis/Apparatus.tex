...
Depending on the article, this process takes around one minute and involves 100--500 API calls, most of which are done in parallel. 
During this process, data is rendered whenever it arrives and has been processed.
...
On a high level, the group mode progresses as follows:
