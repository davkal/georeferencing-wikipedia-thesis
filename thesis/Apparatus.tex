...
\begin{enumerate}
  \item Looking at the HTML source of the page and identifying how the \ac{HTML} tags and attributes that are used to structure the information.
...
\todo{Nice intro: ``The purpose of visualization is insight, not pictures.''\cite[6]{card1999readings}}
...
An implementation would load a user's contribution (MediaWiki API query \entity{usercontribs}), fetch these pages and scan for coordinates, construct a convex hull around them and then determine the center.
