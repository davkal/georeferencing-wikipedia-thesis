...
% ********************************************************************
\newcommand{\myTitle}{Schreiben wir unsere Geschichte selbst?\xspace}
\newcommand{\myDegree}{Diplomarbeit\xspace}
\newcommand{\myName}{David Kaltschmidt\xspace}
\newcommand{\myProf}{Betreuer: Dr. Claudia M\"uller-Birn\xspace}
\newcommand{\myOtherProf}{2. Pr\"ufer: Prof. Dr. Robert Tolksdorf\xspace}
...
\cleardoublepage\part{Überlegungen}
\include{Introduction}
\include{Foundation}
\cleardoublepage\part{Experimentelles}
\include{Apparatus}
\include{Experiment}
%\addtocontents{toc}{\protect\clearpage} % <--- just debug stuff, ignore
\cleardoublepage\part{Ergebnisse}
\include{Results}
\include{Conclusion}
